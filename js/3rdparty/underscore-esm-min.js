...
function collectNonEnumProps(e, t) {
    ...
    for (has$1(e, a) && !t.contains(a) && t.push(a); n--; )
        (a = nonEnumerableProps[n])in e && e[a] !== i[a] && !t.contains(a) && t.push(a)
}
function keys(e) {
    if (!isObject(e))
        return [];
    ...
    for (var n in e)
        has$1(e, n) && t.push(n);
    return hasEnumBug && collectNonEnumProps(e, t),
    t
}
function isEmpty(e) {
    if (null == e)
...
function deepEq(e, t, n, r) {
    e instanceof _$1 && (e = e._wrapped),
    t instanceof _$1 && (t = t._wrapped);
    var i = toString.call(e);
    if (i !== toString.call(t))
        return !1;
    ...
    if (!a && isTypedArray$1(e)) {
        if (getByteLength(e) !== getByteLength(t))
            return !1;
    ...
    if (!a) {
        ...
        var u = e.constructor
          , o = t.constructor;
        if (u !== o && !(isFunction$1(u) && u instanceof u && isFunction$1(o) && o instanceof o) && "constructor"in e && "constructor"in t)
            return !1
    }
    r = r || [];
    ...
    a) {
        ...
        keys(t).length !== s)
            return !1;
        for (; s--; )
            if (!has$1(t, c = f[s]) || !eq(e[c], t[c], n, r))
                return !1
    }
    return n.pop(),
    r.pop(),
...
function template(e, t, n) {
    !t && n && (t = n),
    t = defaults({}, t, _$1.templateSettings);
    ...
    e.replace(r, (function(t, n, r, u, o) {
        return a += e.slice(i, o).replace(escapeRegExp, escapeChar),
        i = o + t.length,
...
function result(e, t, n) {
    ...
    if (!r)
        return isFunction$1(n) ? n.call(e) : n;
    for (var i = 0; i < r; i++) {
        var a = null == e ? void 0 : e[t[i]];
        void 0 === a && (a = n,
        i = r),
        e = isFunction$1(a) ? a.call(e) : a
    }
    return e
}
var idCounter = 0;
...
function memoize(e, t) {
    var n = function(r) {
        ...
        return has$1(i, a) || (i[a] = e.apply(this, arguments)),
        i[a]
    };
    return n.cache = {},
    n
...
function throttle(e, t, n) {
    ...
    var s = function() {
      ...
      , c = function() {
        ...
        o = c,
        u = e.apply(i, a),
        r || (i = a = null)) : r || !1 === n.trailing || (r = setTimeout(s, f)),
        u
    };
...
function createIndexFinder(e, t, n) {
    return function(r, i, a) {
        var u = 0
          , o = getLength(r);
        if ("number" == typeof a)
            e > 0 ? u = a >= 0 ? a : Math.max(a + o, u) : o = a >= 0 ? Math.min(a + 1, o) : a + o + 1;
        else if (n && a && o)
            return r[a = n(r, i)] === i ? a : -1;
        if (i != i)
            return (a = t(slice.call(r, u, o), isNaN$1)) >= 0 ? a + u : -1;
...
function contains(e, t, n, r) {
    return isArrayLike(e) || (e = values(e)),
    ("number" != typeof n || r) && (n = 0),
    indexOf(e, t, n) >= 0
}
var invoke = restArguments((function(e, t, n) {
    var r, i;
    return isFunction$1(t) ? i = t : (t = toPath(t),
    r = t.slice(0, -1),
    t = t[t.length - 1]),
    map(e, (function(e) {
        var a = i;
        if (!a) {
            if (r && r.length && (e = deepGet(e, r)),
            null == e)
                return;
            a = e[t]
        }
...
var pick = restArguments((function(e, t) {
    ...
    if (null == e)
        return n;
    isFunction$1(r) ? (t.length > 1 && (r = optimizeCb(r, t[1])),
    t = allKeys(e)) : (r = keyInObj,
    t = flatten$1(t, !1, !1),
    e = Object(e));
  ...
  , omit = restArguments((function(e, t) {
    var n, r = t[0];
    return isFunction$1(r) ? (r = negate(r),
    t.length > 1 && (n = t[1])) : (t = map(flatten$1(t, !1, !1), String),
    r = function(e, n) {
        return !contains(t, n)
    }
    ),
...
function uniq(e, t, n, r) {
    ...
    for (var i = [], a = [], u = 0, o = getLength(e); u < o; u++) {
        var s = e[u]
          , c = n ? n(s, u, e) : s;
        t && !n ? (u && a === c || i.push(s),
        a = c) : n ? contains(a, c) || (a.push(c),
        i.push(s)) : contains(i, s) || i.push(s)
    }
    return i
}
...
function unzip(e) {
    for (var t = e && max(e, getLength).length || 0, n = Array(t), r = 0; r < t; r++)
        n[r] = pluck(e, r);
    return n
}
...
function mixin(e) {
    return each(functions(e), (function(t) {
        ...
        _$1.prototype[t] = function() {
            var e = [this._wrapped];
            return push.apply(e, arguments),
            chainResult(this, n.apply(_$1, e))
        }
    }
    )),
    _$1
