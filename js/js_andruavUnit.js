...
const CONST_FLIGHT_PX4_OFF_AUTO_TAKEOFF					= 203;
const CONST_FLIGHT_PX4_OFF_AUTO_MISSION					= 203;
const CONST_FLIGHT_PX4_OFF_AUTO_HOLD					= 204;
const CONST_FLIGHT_PX4_OFF_AUTO_RTL						= 205
const CONST_FLIGHT_PX4_OFF_AUTO_LAND					= 206;
const CONST_FLIGHT_PX4_AUTO_FOLLOW_TARGET				= 207;
const CONST_FLIGHT_PX4_AUTO_PRECLAND					= 208;
const CONST_FLIGHT_PX4_OFF_VTOL_TAKEOFF					= 209;
const CONST_FLIGHT_PX4_OFF_ACRO               			= 210;
