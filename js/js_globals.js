...
const EE_onAdvancedMode              = "EE_onAdvancedMode";
const EE_ErrorMessage                = "EE_ErrorMessage";
const EE_adsbExpiredUpdate           = "EE_adsbExpiredUpdate";


const EE_customSONAR            = "EE_customSONAR";
