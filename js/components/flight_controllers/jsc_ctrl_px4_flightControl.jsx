export class CLSS_CTRL_PX4_FLIGHT_CONTROL extends React.Component {
    ...
    fn_doTakeOffPlane(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_TAKEOFF);
    }

    fn_doLand(v_andruavUnit) {
        v_andruavClient.API_do_Land(this.props.v_andruavUnit.partyID);
    }

    fn_doSurface(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_SURFACE);
    }

    fn_doManual(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_MANUAL);
    }

    fn_doStabilize(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_STABILIZE);
    }

    fn_doRTL(v_andruavUnit, smart) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, smart == true ? CONST_FLIGHT_CONTROL_SMART_RTL : CONST_FLIGHT_CONTROL_RTL);
    }


    fn_doCruise(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_CRUISE);
    }


    fn_doFBWA(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_FBWA);
    }

    fn_doFBWB(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_FBWB);
    }


    fn_doQStabilize(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_QSTABILIZE);
    }
    fn_doQLoiter(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_QLOITER);
    }
    fn_doQHover(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_QHOVER);
    }
    fn_doQLand(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_QLAND);
    }
    fn_doQRTL(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_QRTL);
    }
    ...
    fn_doGuided(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_GUIDED);
    }

    fn_doAuto(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_AUTO);
    }

    fn_doPosHold(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_POSTION_HOLD);
    }

    fn_doLoiter(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_LOITER);
    }

    fn_doBrake(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_BRAKE);
    }

    fn_doHold(v_andruavUnit) {
        v_andruavClient.API_do_FlightMode(this.props.v_andruavUnit.partyID, CONST_FLIGHT_CONTROL_HOLD);
    }
        ...
        switch (this.props.v_andruavUnit.m_VehicleType)
        {
            case  VEHICLE_PLANE:
                ...
                ctrl.push(<div key={this.props.id+"rc2"}  id={this.props.id+"rc2"}  className= 'col-12  al_l ctrldiv'><div className='btn-group '>
                    ...
                    <button id='btn_speed' type='button' className={'btn btn-sm  flgtctrlbtn ' + btn.btn_speed_class } onClick={ (e) => this.fn_changeSpeed(e,this.props.v_andruavUnit,this.props.v_andruavUnit.m_Nav_Info.p_Location.speed!=null?this.props.v_andruavUnit.m_Nav_Info.p_Location.speed:this.localvars.speed_link)}>&nbsp;GS&nbsp;</button>
                    <button id='btn_servos' type='button' className={'btn btn-sm  flgtctrlbtn ' + btn.btn_servo_class } onClick={ (e) => this.fn_ServoControl(e,this.props.v_andruavUnit)}>&nbsp;SRV&nbsp;</button>
                    </div></div>);
