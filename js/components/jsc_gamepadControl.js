...
class CLSS_GamePadControl extends React.Component {
    ...
    fn_requestGamePad(p_me,p_andruavUnit)
    {
        ...
        $('#modal_ctrl_gamepad').find('#btnGoto').click(function () {
            fn_gotoUnit($('#modal_ctrl_gamepad').attr(p_andruavUnit.partyID));
        });
    ...
    componentDidMount () {
        ...
        $('#modal_ctrl_gamepad').find('#btnGoto').click(function () {
            fn_gotoUnit($('#modal_ctrl_gamepad').attr('partyID'));
        });
    }
    ...
    render()
    {
        ...
        return (<div id="modal_ctrl_gamepad" title="GamePad Control" className="localcontainer css_ontop">
                    <h4 id="title" className="modal-title text-primary">GamePad of {v_title} </h4>
                    {this.m_output}
					<div id="modal_gamepad_footer" className="form-group text-center localcontainer">
                        <div className = "row">
                            ...
                            <div className="dropdown">
                                <button className="btn  btn-xs btn-danger" type="button" data-toggle="dropdown">{"Mode " + c_mode.toString() + " "}
