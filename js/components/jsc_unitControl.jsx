...
import {CLSS_CTRL_SONAR} from './plugins/jsc_ctrl_sonar.jsx'
     ...
     return (
             ...
             <div  key={id +"_1"} id={v_andruavUnit.partyID + "_1"} className='row margin_2px padding_zero user-select-none d-none d-sm-flex'>        	
                ...
                <ul key={v_andruavUnit.partyID + 'ul'} className="nav nav-tabs">
                    ...
                    <li key={v_andruavUnit.partyID + 'li4'} className="nav-item">
                        <a className="nav-link  " data-bs-toggle="tab" href={"#sonar" + v_andruavUnit.partyID}>Sonar</a>
                    </li>
                    <li key={v_andruavUnit.partyID + 'li5'} className="nav-item">
                ...
                <div key={v_andruavUnit.partyID + 'myTabContent'} id="myTabContent" className="tab-content padding_zero">
                    ...
                    <div key={v_andruavUnit.partyID + 'myTabContent_4'} className="tab-pane fade" id={"sonar" + v_andruavUnit.partyID}>
                            <CLSS_CTRL_SONAR p_unit={v_andruavUnit}/>
                    </div>
                    <div key={v_andruavUnit.partyID + 'myTabContent_5'} className="tab-pane fade"   id={"empty" + v_andruavUnit.partyID}>
                    </div>
                </div>
            </div>		
       );
    ...
    render() {
        ...
        else 
        {
            ...
            this.state.andruavUnitPartyIDs.map(function (partyID)
            {
                ...
                {
                    units_gcs.push (<CLSS_AndruavUnit_GCS key={'CLSS_AndruavUnit_GCS' + partyID} v_en_GCS= {window.AndruavLibs.LocalStorage.fn_getGCSDisplayEnabled()} m_unit = {v_andruavUnit}/>);
                }
                else 
