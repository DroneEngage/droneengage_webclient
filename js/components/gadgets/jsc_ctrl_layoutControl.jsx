    ...
    render() {
        ...
        return (
            <div id="main_btn_group"  role="group" aria-label="Basic example">
                ...
                <button type="button" id="btn_showControl" className="btn btn-primary btn-sm ctrlbtn  d-inline d-sm-none" title='Change Screen Layout' onClick={(e) => fn_showControl(true)}><strong>{'display-' + v_display_mode}</strong></button>
            </div>
        );
    }
}
